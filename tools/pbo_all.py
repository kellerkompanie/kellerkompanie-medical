...
if __name__ == '__main__':
    ...
    filenames = glob.glob('keko_medical_*')
    ...
    for filename in filenames:
        ...
        command = '"D:\\SteamLibrary\\steamapps\\common\\Arma 3 Tools\\FileBank\\FileBank.exe" -dst "C:\\Users\\Schwaggot\\Development\\kellerkompanie-medical\\release" "' + filename_abs + '"'
