class CfgVehicles {
    ...
    class GVAR(PainkillerItem): WeaponHolder_Single_limited_item_F {
        scope = 2;
        scopeCurator = 2;
        ...
        class TransportItems {
            MACRO_ADDITEM(GVAR(Painkiller),1);
        };
    };
    ...
    class ACE_medicalSupplyCrate_advanced: ACE_medicalSupplyCrate {
        ...
        class TransportMagazines: TransportMagazines {
            MACRO_ADDMAGAZINE(GVAR(Painkiller),10);
        };
    };
    class GVAR(medicalSupplyCrate): ACE_medicalSupplyCrate {
        displayName = CSTRING(bloodbank);
        class TransportItems: TransportItems {
            MACRO_ADDITEM(GVAR(CrossPanel),5);
            MACRO_ADDITEM(GVAR(bloodIV_O),5);
            MACRO_ADDITEM(GVAR(bloodIV_A),10);
            MACRO_ADDITEM(GVAR(bloodIV_B),10);
            MACRO_ADDITEM(GVAR(bloodIV_AB),10);
            MACRO_ADDITEM(GVAR(bloodIV_O_500),5);
            MACRO_ADDITEM(GVAR(bloodIV_A_500),10);
            MACRO_ADDITEM(GVAR(bloodIV_B_500),10);
            MACRO_ADDITEM(GVAR(bloodIV_AB_500),10);
            MACRO_ADDITEM(GVAR(bloodIV_O_250),5);
            MACRO_ADDITEM(GVAR(bloodIV_A_250),10);
            MACRO_ADDITEM(GVAR(bloodIV_B_250),10);
            MACRO_ADDITEM(GVAR(bloodIV_AB_250),10);
        };
    };
        ...
        class ACE_SelfActions {
            ...
            class ACE_Equipment {
                ...
                class openCrossPanel {
                    ...
                    condition = "('keko_medical_circulation_CrossPanel' in (uniformItems _player)) || ('keko_medical_circulation_CrossPanel' in (vestItems _player))";
