 ...
 *
 * Example:
 * [player, cursorTarget] call keko_medical_breathing_fnc_treatmentAdvanced_pulseoximeterLocal;
 *
 * Public: No
 */
...
[{
    ...
    [_target, "quick_view", LSTRING(pulseoxi_Log)] call EFUNC(breathing,removeLog);
